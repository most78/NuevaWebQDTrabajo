		...
		<div class="wrapper">
			...
			<nav  itemscope itemtype='http://schema.org/SiteNavigationElement' role='navigation' class="main-nav">
				...
				<ul class="fadeInRight">
					...
					<li><a itemprop='url'  class="animsition-link <?php echo ($page_name=='conoce-Qdqmedia.php')?'active':'';?>" href="conoce-Qdqmedia.php"><span itemprop='name'>quíenes somos</span></a></li>
					<li><a itemprop='url'  class="animsition-link <?php echo ($page_name=='ofertas-qdqmedia.php')?'active':'';?>" href="ofertas-qdqmedia.php"><span itemprop='name'>ofertas</span></a></li>
